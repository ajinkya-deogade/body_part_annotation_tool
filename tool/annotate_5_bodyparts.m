...
clc;
tic;
initFolder = 'F:\MHDO_Tracking\data\Janelia_Q2_2015\20150501_MPEG4_NoOdor';
...
prompt= 'Enter the number of frames to be annotated: ';
parse_number_of_frames = input(prompt);
...
iter=floor(total_number_of_frames/parse_number_of_frames)
j = 1;
...
while j <= parse_number_of_frames
    ...
    % Annotate Left Mouth hook - press m
    ...
    % Annotate Right Mouth-hook - press m
    ...
    % Annotate Left Dorsal Organ - press m
    ...
    % Annotate Right Dorsal Organ - press m
