...
initFolder = '/Volumes/NewHD/Dropbox (CRG)/Tracker Development (Ajinkya)/MHDO_Tracking/data/Janelia_Q1_2017/20170224_forValidation/';
...
experimentName = 'Annotations_And_Frames_Continuos';
...
prompt= 'How many frames to Annotate : ';
nMax_frames = input(prompt);
iter = 1;
...
allInfo = struct('VideoFile',videoName,'DateAndTime',dat,'ExtractedFramesPath',frameFolder,'NumberOfFrames', nMax_frames,'Annotations',[]);
coordinate = [];
frame_start = 1;
...
% i = round(((total_number_of_frames-nMax_frames)-1)*random_number + 1)
i = 1;
